...
scanLimitsTab::scanLimitsTab(QWidget* parent)
    : QWidget(parent)
    , ui(new Ui::scanLimitsTab)
{
    ui->setupUi(this);
    setupFile = new setupFileHandler(QDir::homePath() + "/.clamav-gui/settings.ini");
    if (setupFile->sectionExists("ScanLimitations") == true)
    { updateLimits(); }
    else
    { writeLimits(); }
}
...
void scanLimitsTab::writeLimits()
{
    ...
    value = QString::number(ui->maxAmountForContainerSpinBox->value()) + ui->maxAmountForContainerComboBox
        ->currentText();
    ...
    value = QString::number(ui->maxNumberForContainerSpinBox->value()) + ui->maxNumberForContainerComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->maxArchiveRecursionForContainerSpinBox->value()) + ui->maxArchiveRecursionForContainerComboBox
                ->currentText();
    ...
    value = QString::number(ui->maxSizeHTMLFileToNormalizeSpinBox->value()) + ui->maxSizeHTMLFileToNormalizeComboBox
        ->currentText();
    ...
    value = QString::number(ui->maxSizeOfNormalizedHTMLFileSpinBox->value()) + ui->maxSizeOfNormalizedHTMLFileComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->maxSizeOfScriptFileToNormalizeSpinBox->value()) + ui->maxSizeOfScriptFileToNormalizeComboBox->currentText();
    ...
    value = QString::number(ui->maxSizeZipToTypeReanalzeSpinBox->value()) + ui->maxSizeZipToTypeReanalzeComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->maxNumberOfPartitionsInDiskImageSpinBox->value()) + ui->maxNumberOfPartitionsInDiskImageComboBox
                ->currentText();
    ...
    value = QString::number(ui->maxNumberOfIconsInPEFileSpinBox->value()) + ui->maxNumberOfIconsInPEFileComboBox
        ->currentText();
...
void scanLimitsTab::updateLimits()
{
    ...
    checked == "checked" ? ui->filesLargerThanThisCheckBox->setChecked(true) : ui->filesLargerThanThisCheckBox
        ->setChecked(false);
    ...
    checked == "checked" ? ui->maxAmountForContainerCheckBox->setChecked(true) : ui->maxAmountForContainerCheckBox
        ->setChecked(false);
    ...
    checked == "checked" ? ui->maxNumberForContainerCheckBox->setChecked(true) : ui->maxNumberForContainerCheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxArchiveRecursionForContainerComboBox
            ->setCurrentIndex(ui->maxArchiveRecursionForContainerComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked"
    ? ui->maxArchiveRecursionForContainerCheckBox->setChecked(true)
    : ui->maxArchiveRecursionForContainerCheckBox->setChecked(false);
    ...
    checked == "checked" ? ui->maxDirRecursionLevelCheckBox->setChecked(true) : ui->maxDirRecursionLevelCheckBox
        ->setChecked(false);
    ...
    checked == "checked" ? ui->maxSizeFileForPECheckBox->setChecked(true) : ui->maxSizeFileForPECheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxSizeHTMLFileToNormalizeComboBox
            ->setCurrentIndex(ui->maxSizeHTMLFileToNormalizeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked"
    ? ui->maxSizeHTMLFileToNormalizeCheckBox->setChecked(true)
    : ui->maxSizeHTMLFileToNormalizeCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxSizeOfNormalizedHTMLFileComboBox
            ->setCurrentIndex(ui->maxSizeOfNormalizedHTMLFileComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked"
    ? ui->maxSizeOfNormalizedHTMLFileCheckBox->setChecked(true)
    : ui->maxSizeOfNormalizedHTMLFileCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxSizeOfScriptFileToNormalizeComboBox
            ->setCurrentIndex(ui->maxSizeOfScriptFileToNormalizeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked"
    ? ui->maxSizeOfScriptFileToNormalizeCheckBox->setChecked(true)
    : ui->maxSizeOfScriptFileToNormalizeCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxSizeZipToTypeReanalzeComboBox
            ->setCurrentIndex(ui->maxSizeZipToTypeReanalzeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked" ? ui->maxSizeZipToTypeReanalzeCheckBox->setChecked(true) : ui->maxSizeZipToTypeReanalzeCheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxNumberOfPartitionsInDiskImageComboBox
            ->setCurrentIndex(ui->maxNumberOfPartitionsInDiskImageComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked"
    ? ui->maxNumberOfPartitionsInDiskImageCheckBox->setChecked(true)
    : ui->maxNumberOfPartitionsInDiskImageCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->maxNumberOfIconsInPEFileComboBox
            ->setCurrentIndex(ui->maxNumberOfIconsInPEFileComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    checked == "checked" ? ui->maxNumberOfIconsInPEFileCheckBox->setChecked(true) : ui->maxNumberOfIconsInPEFileCheckBox
        ->setChecked(false);
    ...
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked"
    ? ui->numberOfSecondsToWaitForResponseCheckBox->setChecked(true)
    : ui->numberOfSecondsToWaitForResponseCheckBox->setChecked(false);
