...
dragablePushButton::dragablePushButton(QWidget* parent)
    : QPushButton(parent)
    , ui(new Ui::dragablePushButton)
{
    //ui->setupUi(this);
}

dragablePushButton::dragablePushButton(QIcon icon, QString text, QWidget* parent, QString dragText)
