...
ProfileWizardDialog::ProfileWizardDialog(QWidget* parent, QString name)
    : QDialog(parent)
    , profileName(name)
    , ui(new Ui::ProfileWizardDialog)
{
    ui->setupUi(this);
...
// DIRECTORIES
    ...
    checked == "checked" ? ui->loadVirusDatabaseCheckBox->setChecked(true) : ui->loadVirusDatabaseCheckBox
        ->setChecked(false);
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->scanReportToFileCheckBox->setChecked(true) : ui->scanReportToFileCheckBox
        ->setChecked(false);
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->scanFilesFromFileCheckBox->setChecked(true) : ui->scanFilesFromFileCheckBox
        ->setChecked(false);
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->followDirectorySymlinksCheckBox->setChecked(true) : ui->followDirectorySymlinksCheckBox
        ->setChecked(false);
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->followFileSymlinksCheckBox->setChecked(true) : ui->followFileSymlinksCheckBox
        ->setChecked(false);
...
// INCLUDE / EXCLUDE
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->pwdontScanFileNameCheckBox->setChecked(true) : ui->pwdontScanFileNameCheckBox
        ->setChecked(false);
    ...
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked" ? ui->pwonlyScanFileNameCheckBox->setChecked(true) : ui->pwonlyScanFileNameCheckBox
        ->setChecked(false);
...
// SCANLIMITS
    ...
    checked == "checked" ? ui->pwfilesLargerThanThisCheckBox->setChecked(true) : ui->pwfilesLargerThanThisCheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxAmountForContainerComboBox
            ->setCurrentIndex(ui->pwmaxAmountForContainerComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked" ? ui->pwmaxAmountForContainerCheckBox->setChecked(true) : ui->pwmaxAmountForContainerCheckBox
        ->setChecked(false);
    ui->pwmaxAmountForContainerSpinBox->setValue(value.toInt());

    value = setupFile->getSectionValue("ScanLimitations",
                                       "The maximum number of files to scan for each container file");
    checked = value.left(value.indexOf("|"));
    value = value.mid(value.indexOf("|") + 1);
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxNumberForContainerComboBox
            ->setCurrentIndex(ui->pwmaxNumberForContainerComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked" ? ui->pwmaxNumberForContainerCheckBox->setChecked(true) : ui->pwmaxNumberForContainerCheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxArchiveRecursionForContainerComboBox
            ->setCurrentIndex(ui->pwmaxArchiveRecursionForContainerComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxArchiveRecursionForContainerCheckBox->setChecked(true)
    : ui->pwmaxArchiveRecursionForContainerCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxDirRecursionLevelComboBox
            ->setCurrentIndex(ui->pwmaxDirRecursionLevelComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked" ? ui->pwmaxDirRecursionLevelCheckBox->setChecked(true) : ui->pwmaxDirRecursionLevelCheckBox
        ->setChecked(false);
    ...
    checked == "checked" ? ui->pwmaxSizeFileForPECheckBox->setChecked(true) : ui->pwmaxSizeFileForPECheckBox
        ->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxSizeHTMLFileToNormalizeComboBox
            ->setCurrentIndex(ui->pwmaxSizeHTMLFileToNormalizeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxSizeHTMLFileToNormalizeCheckBox->setChecked(true)
    : ui->pwmaxSizeHTMLFileToNormalizeCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxSizeOfNormalizedHTMLFileComboBox
            ->setCurrentIndex(ui->pwmaxSizeOfNormalizedHTMLFileComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxSizeOfNormalizedHTMLFileCheckBox->setChecked(true)
    : ui->pwmaxSizeOfNormalizedHTMLFileCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxSizeOfScriptFileToNormalizeComboBox
            ->setCurrentIndex(ui->pwmaxSizeOfScriptFileToNormalizeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxSizeOfScriptFileToNormalizeCheckBox->setChecked(true)
    : ui->pwmaxSizeOfScriptFileToNormalizeCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxSizeZipToTypeReanalzeComboBox
            ->setCurrentIndex(ui->pwmaxSizeZipToTypeReanalzeComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxSizeZipToTypeReanalzeCheckBox->setChecked(true)
    : ui->pwmaxSizeZipToTypeReanalzeCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxNumberOfPartitionsInDiskImageComboBox
            ->setCurrentIndex(ui->pwmaxNumberOfPartitionsInDiskImageComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxNumberOfPartitionsInDiskImageCheckBox->setChecked(true)
    : ui->pwmaxNumberOfPartitionsInDiskImageCheckBox->setChecked(false);
    ...
    if ((value.right(1) == "K") || (value.right(1) == "M") || (value.right(1) == "G"))
    {
        ui->pwmaxNumberOfIconsInPEFileComboBox
            ->setCurrentIndex(ui->pwmaxNumberOfIconsInPEFileComboBox->findText(value.right(1)));
        value = value.left(value.length() - 1);
    }
    else
    {
    ...
    checked == "checked"
    ? ui->pwmaxNumberOfIconsInPEFileCheckBox->setChecked(true)
    : ui->pwmaxNumberOfIconsInPEFileCheckBox->setChecked(false);
    ...
    value = value.mid(value.indexOf("|") + 1);
    checked == "checked"
    ? ui->pwnumberOfSecondsToWaitForResponseCheckBox->setChecked(true)
    : ui->pwnumberOfSecondsToWaitForResponseCheckBox->setChecked(false);
...
void ProfileWizardDialog::slot_checkNavigationButtons()
{
    ...
    switch (index)
    {
        ...
        case 1  :
            ...
            if ((ui->profileNameLineEdit->text() == "") | (checkFile.exists()))
            {
                ui->nextButton
                    ->setEnabled(false);
            }
...
{
    model->checkedIndexes.count() == 0 ? ui->nextButton->setEnabled(false) : ui->nextButton->setEnabled(true);
}

void ProfileWizardDialog::slot_loadAllSupportedDBButtonClicked()
{
    QString folder = QFileDialog::getExistingDirectory(this, tr("Signature Folder"),
                                                       ui->loadVirusDatabaseLineEdit->text());
    if (folder != "")
    { ui->loadVirusDatabaseLineEdit->setText(folder); }
}
...
void ProfileWizardDialog::slot_saveScanReportToFileButtonClicked()
{
    ...
    if (filename != "")
    { ui->scanReportToFileLineEdit->setText(filename); }
}
...
void ProfileWizardDialog::slot_scanFromFileButtonClicked()
{
    ...
    if (filename != "")
    { ui->scanFilesFromFileLineEdit->setText(filename); }
}

void ProfileWizardDialog::slot_createTempFilesButtonClicked()
{
    QString folder = QFileDialog::getExistingDirectory(this, tr("Folder for temporary files"),
                                                       ui->tempFilesLineEdit->text());
    if (folder != "")
    { ui->tempFilesLineEdit->setText(folder); }
}

void ProfileWizardDialog::slot_moveInfectedFilesButtonClicked()
{
    QString folder = QFileDialog::getExistingDirectory(this, tr("Move Folder for infected Files"),
                                                       ui->moveDirectoryLineEdit->text());
    if (folder != "")
    { ui->moveDirectoryLineEdit->setText(folder); }
}

void ProfileWizardDialog::slot_copyInfectedFilesButtonClicked()
{
    QString folder = QFileDialog::getExistingDirectory(this, tr("Copy Folder for infected Files"),
                                                       ui->copyDirectoryLineEdit->text());
    if (folder != "")
    { ui->copyDirectoryLineEdit->setText(folder); }
}
...
void ProfileWizardDialog::slot_createButtonClicked()
{
    ...
    setupFileHandler* profiles = new setupFileHandler(
        QDir::homePath() + "/.clamav-gui/profiles/" + profileName + ".ini");
    QString line;
    QString section = "REGEXP_and_IncludeExclude";
    QString checked;
    QString keyword;
    ...
    auto index = 0;
    for (auto i = model->checkedIndexes.begin(); i != model->checkedIndexes.end(); i++)
    {
        index++;
        if (index < model->checkedIndexes.count() - 1)
        {
            directories = directories + i->data(QFileSystemModel::FilePathRole).toString() + "\n";
        }
        else
        {
            directories = directories + i->data(QFileSystemModel::FilePathRole).toString();
    ...
    value = QString::number(ui->pwfilesLargerThanThisSpinBox->value()) + ui->pwfilesLargerThanThisComboBox
        ->currentText();
    ...
    value = QString::number(ui->pwmaxAmountForContainerSpinBox->value()) + ui->pwmaxAmountForContainerComboBox
        ->currentText();
    ...
    value = QString::number(ui->pwmaxNumberForContainerSpinBox->value()) + ui->pwmaxNumberForContainerComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->pwmaxArchiveRecursionForContainerSpinBox->value()) + ui->pwmaxArchiveRecursionForContainerComboBox
                ->currentText();
    ...
    value = QString::number(ui->pwmaxDirRecursionLevelSpinBox->value()) + ui->pwmaxDirRecursionLevelComboBox
        ->currentText();
    ...
    value = QString::number(ui->pwmaxSizeHTMLFileToNormalizeSpinBox->value()) + ui->pwmaxSizeHTMLFileToNormalizeComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->pwmaxSizeOfNormalizedHTMLFileSpinBox->value()) + ui->pwmaxSizeOfNormalizedHTMLFileComboBox->currentText();
    ...
    value = QString::number(
        ui->pwmaxSizeOfScriptFileToNormalizeSpinBox->value()) + ui->pwmaxSizeOfScriptFileToNormalizeComboBox
                ->currentText();
    ...
    value = QString::number(ui->pwmaxSizeZipToTypeReanalzeSpinBox->value()) + ui->pwmaxSizeZipToTypeReanalzeComboBox
        ->currentText();
    ...
    value = QString::number(
        ui->pwmaxNumberOfPartitionsInDiskImageSpinBox->value()) + ui->pwmaxNumberOfPartitionsInDiskImageComboBox
                ->currentText();
    ...
    value = QString::number(ui->pwmaxNumberOfIconsInPEFileSpinBox->value()) + ui->pwmaxNumberOfIconsInPEFileComboBox
        ->currentText();
