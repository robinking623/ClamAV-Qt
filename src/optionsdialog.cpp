    ...
    , ui(new Ui::optionsDialog)
{
    ...
    if (setupFile->sectionExists("AvailableOptions") == true)
    { updateOptionLists(); }
    else
    { writeOptionLists(); }
    updateDirectories();
...
{
    QString rc;
    rc = QFileDialog::getExistingDirectory(this, tr("Select Directory"), QDir::homePath() + "/.clamav-gui/signatures",
...
void optionsDialog::slot_selectCDButtonClicked()
{
    ...
    if (rc != "")
    { ui->copyDirectoryLineEdit->setText(rc); }
    writeDirectories();
}
...
void optionsDialog::slot_selectMDButtonClicked()
{
    ...
    rc = QFileDialog::getExistingDirectory(this, tr("Select Directory"), QDir::homePath() + "/.clamav-gui/quarantine");
    if (rc != "")
    { ui->moveDirectoryLineEdit->setText(rc); }
...
void optionsDialog::slot_selectSRTFButtonClicked()
{
    ...
    if (rc != "")
    { ui->scanReportToFileLineEdit->setText(rc); }
    writeDirectories();
}
...
void optionsDialog::slot_selectSFFButtonClicked()
{
    ...
    if (rc != "")
    { ui->scanFilesFromFileLineEdit->setText(rc); }
    writeDirectories();
}
...
void optionsDialog::slot_selectTDButtonClicked()
{
    ...
    if (rc != "")
    { ui->tempFilesLineEdit->setText(rc); }
    writeDirectories();
}
